...
export const workExperience = [
  {
    ...
    desc: "Architected PL/SQL procedures to deduplicate 19,000+ customer records; designed item-hierarchy identifier system for product data; data cleansing and merging with TOAD for Oracle.",
  ...
  },
  {
    ...
    desc: "Architected Spring Boot workflow engine for server-side state compliance; engineered JWT-based RBAC; normalized PostgreSQL schemas with JPA/Hibernate; OAuth and Firebase Authentication.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },
  {
    ...
    desc: "Developed stateful decision engine and REST orchestration for 200+ offerings; engineered validation layers for 100% data consistency across distributed enterprise modules.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
  },
  {
    id: 4,
    title: "Software Engineer · Oracle Solution Services",
    desc: "Engineered Node.js integration services; architected analytics platform for 200+ engineers (6-week design cycle reduction); designed enterprise RBAC with multi-level approval workflows.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
  {
    ...
    desc: "Optimized Node.js APIs and Redis pipelining for 2M+ daily calculations (45% latency reduction); real-time orchestration and data pipelines for predictive maintenance.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
